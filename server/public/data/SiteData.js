...
const DNACategories = [
    { title: "Conversion and Processing", entries: ["fasta-to-fastq", "fast5-to-fastq", "bcl2fastq", "sam-to-bam", "sort-bam-file", "index-bam-file", "fastqc"]},
    { title: "Trimming and Alignment", entries: ["trimming", "alignment-bwamem", "alignment-bowtie", "alignment-bowtie2", "mark-or-remove-duplicates"]},
    ...
    { title: "Graphing, Statistics and Sequencing", entries: ["add-or-replace-read-groups", "bam-index-stats", "flag-stats", "alignment-summary", "gc-bias-summary", "insert-size-summary", "create-sequence-dictionary", "sequence-depth", "sequence-coverage"] },
...
let RNAExecutables = new Map([
    ...
    ["star-alignment", new Executable(
        ...
        'star',
        ['', ''],
        [new Parameter("Star Alignment Reference Genome", 'select', refGenomeOptions, 'ref_genome', 'hgch38_index')], //cbtt, hard coded index
        "STAR --genomeDir /usr/refs/index_files/star_indices/ecoli --readFilesIn /<main_file_read1> /<main_file_read2> --outFileNamePrefix /usr/output/Star_Alignment_Output.star", // CBTT, choose a static output prefix
    ...
    ["salmon-alignment", new Executable(
        ...
        ], // cbtt, hard coded index
        "salmon quant -i /usr/refs/index_files/salmon_indices_noDecoy/house_mouse -l A -1 <main_file_read1> -2 <main_file_read2> -o usr/output/Salmon_Alignment_Output",
    ...
    ["htseq-alignment", new Executable(
        false,
        "HTSeq Alignment",
        'BioQule_sorted.bam', //'Aligned_Reads_BAM.bam', // aligned_reads_bam file
        'htseq',
        ['', ''],
    ...
    ["featureCounts-alignment", new Executable(
        ...
        "featureCounts -a /usr/refs/RNA/<genes_gtf>/<genes_gtf>.gtf -o /usr/output/feature_counts.txt -p /<main_file>",
